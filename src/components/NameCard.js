...
export default function NameCard() {
    const names = ["Ray", "TJ", "Brantley", "Colleen", "Kasie", "Hunter", "Miz", "Christopher", "Amber", "Marvin", "Lakenya", "Taj", "Tony", "Stephen", "Jeff", "Jess", "Evan"].sort();
                    ...
                    <Col className="name-col">
                        <Card className="name-card">
                            ...
                            <Card.Body className="name-card-body">
                                <Card.Title className="name-card-title">{names[idx].toLocaleUpperCase()}</Card.Title>
